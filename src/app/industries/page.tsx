        ...
        <section className="bg-white border-b border-[#E5E7EB] py-16 md:py-20">
          <div className="mx-auto max-w-[1600px] px-6 md:px-12">
            <div className="max-w-3xl">
              <Reveal>
                <Overline color="text-[#002FA7]">Application Sectors</Overline>
              </Reveal>
              <Reveal delay={0.1}>
                <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-light text-[#0A0A0A] tracking-tight mt-4">
                  Engineering Solutions for <span className="text-[#002FA7] font-medium">Diverse Industries</span>
                </h1>
              </Reveal>
              <Reveal delay={0.2}>
            ...
            <Reveal key={ind.id} delay={i * 0.05} className="bg-white border border-[#E5E7EB] p-8 md:p-12">
              <div className="grid lg:grid-cols-12 gap-8 items-center">
                <div className="lg:col-span-7">
                  <span className="font-mono text-xs text-[#002FA7] font-bold uppercase tracking-wider bg-[#002FA7]/10 px-3 py-1 rounded-sm">
                  ...
                  <div className="space-y-3 mb-8">
                    ...
                    {ind.highlights.map((h) => (
                      <div key={h} className="flex items-center gap-2.5 text-sm text-[#525252] font-light">
                        <CheckCircle2 size={16} className="text-[#002FA7] shrink-0" />
                        <span>{h}</span>
                      </div>
                    ))}
                  </div>
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-2 bg-[#0A0A0A] text-white px-6 py-3 text-xs font-mono uppercase tracking-widest font-semibold hover:bg-[#002FA7] transition-colors"
                  >
                ...
                <div className="lg:col-span-5 bg-[#F9FAFB] border border-[#E5E7EB] p-8 rounded-lg">
                  <div className="space-y-4">
                    <div className="flex items-center gap-3 text-sm font-mono text-[#002FA7]">
                      <Zap size={18} />
