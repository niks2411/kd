          ...
          {INDUSTRIES.map((ind, i) => (
            <Reveal key={ind.name} delay={0}>
              ...
              >
                ...
                <h3 className={`md:col-span-4 font-display text-2xl md:text-3xl font-light tracking-tight transition-colors duration-300 ${active === i ? "text-[#fd0000] font-medium" : "text-[#0A0A0A]"}`}>
                  {ind.name}
                </h3>
