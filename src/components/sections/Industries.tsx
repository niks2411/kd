    ...
    <section id="industries" className="bg-[#F9FAFB] py-28 md:py-40" data-testid="industries">
      <div className="mx-auto max-w-[1600px] px-6 md:px-12">
        <div className="max-w-3xl mb-16 md:mb-20">
          <Reveal><Overline color="text-[#C5221F]">Industries We Serve</Overline></Reveal>
          <Reveal delay={0.1}>
          ...
          {INDUSTRIES.map((ind, i) => (
            <Reveal key={ind.name} delay={0}>
              ...
              >
                ...
                <h3 className={`md:col-span-4 font-display text-2xl md:text-3xl font-light tracking-tight transition-colors duration-300 ${active === i ? "text-[#C5221F] font-medium" : "text-[#0A0A0A]"}`}>
                  {ind.name}
                </h3>
